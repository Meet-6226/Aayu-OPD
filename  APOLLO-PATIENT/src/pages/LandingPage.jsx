      ...
      <section className="relative pt-[112px] pb-[64px] lg:pt-[144px] lg:pb-[112px] bg-gradient-to-b from-[#f2fcfb] via-white to-[#f8fafc] overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            {/* RIGHT COLUMN — Isolated Smartphone App Preview */}
            <div className="hidden lg:block lg:col-span-5 relative">
              <div className="relative mx-auto max-w-[320px]">
                
                {/* Isolated Phone Mockup Image */}
                <div className="relative z-20 drop-shadow-[0_25px_45px_rgba(0,0,0,0.18)] transition-transform duration-500 hover:scale-[1.02]">
                  <img
                ...
                <div className="absolute top-10 -right-10 z-30 bg-white/95 backdrop-blur-md border border-gray-200/80 rounded-2xl p-3.5 shadow-xl flex items-center gap-3 animate-bounce-subtle">
                  ...
                  <div className="text-left">
                    <p className="text-[12.5px] font-bold text-gray-900 leading-none">Slot Confirmed</p>
                    <p className="text-[10.5px] text-emerald-600 font-medium mt-1 leading-none">WhatsApp alert sent ✓</p>
                  </div>
                </div>

                {/* Floating Badge 2 — Bottom Left */}
                <div className="absolute bottom-10 -left-10 z-30 bg-white/95 backdrop-blur-md border border-gray-200/80 rounded-2xl p-3.5 shadow-xl flex items-center gap-3">
                  <div className="w-8.5 h-8.5 rounded-full bg-teal-100 text-primary-teal flex items-center justify-center shrink-0">
                    <Clock className="h-4 w-4" />
                  </div>
                  <div className="text-left">
                    <p className="text-[12.5px] font-bold text-gray-900 leading-none">Live GPS Transit</p>
                    <p className="text-[10.5px] text-gray-500 mt-1 leading-none">15 mins (5.2 km) to clinic</p>
                  </div>
                </div>
