...
export async function predictNoShowRisk(appointmentData) {
  ...
  const payload = {
    ...
    is_working_professional: persona === "working_professional",
    is_elderly:              persona === "elderly",
    is_student:              persona === "student",
    persona_set:             !!persona,
    family_notified:         appointmentData.familyNotified      || false,
    weather_rain:            appointmentData.weatherRain ?? false,
    traffic_congestion_score: appointmentData.trafficCongestionScore ?? 0.3,
