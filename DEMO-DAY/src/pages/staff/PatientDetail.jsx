...
export default function PatientDetailPage() {
  ...
  const handleSendReminder = async () => {
    ...
    const messageBody = `Aayu Clinic OPD: Hi ${patient.name}, this is a reminder for your appointment with ${appt.doctorName} on ${appt.appointmentDate} at ${appt.appointmentTime}. Please reply 1 to confirm.`;
              ...
              <div style={{ flex: 1, minWidth: 200, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                >
                  ...
                  <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%' }} viewBox="0 0 290 110" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="250" y="16" fill="#15803d" fontSize="4.5" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">Aayu Park</text>
