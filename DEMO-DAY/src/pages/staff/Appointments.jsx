...
export default function AppointmentsPage() {
  ...
  const handleRemind = async (apt) => {
    try {
      ...
      const messageBody = `Apollo Hospital OPD: Hi ${apt.name}, a reminder for your appointment with ${apt.doctor} today at ${apt.time}. Reply 1 to confirm, 2 to reschedule.`;
